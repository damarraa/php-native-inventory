...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT a.id_keluar,a.tanggal_keluar,a.ref_ticket,a.kode_barang,a.jumlah,a.penerima,b.kode_barang,b.nama_barang,b.satuan
                                    FROM sb_barang_keluar as a INNER JOIN sb_stok_barang as b ON a.kode_barang=b.kode_barang
    ...
    // jika data tidak ada
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td width='80' height='13' align='center' valign='middle'>$data[ref_ticket]</td>
                        <td width='100' height='13' align='center' valign='middle'>$data[kode_barang]</td>
                        <td style='padding-left:5px;' width='120' height='13' valign='middle' align='center'>$data[nama_barang]</td>
...
<?php
$filename="LAPORAN DATA STOK KELUAR.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
