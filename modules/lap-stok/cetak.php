...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    <head>
        ...
        <title>LAPORAN DATA STOK TONER</title>
        <link rel="stylesheet" type="text/css" href="../../assets/css/laporan.css" />
    </head>
    <body>
        <div id="title">
            LAPORAN DATA STOK TONER 
        </div>
            ...
            <table id="datastok" width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle">TIPE PRINTER</th>
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td style='padding-left:5px;' width='180' height='13' valign='middle'>$data[tipe_printer]</td>
...
<?php
$filename="LAPORAN STOK TONER.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
