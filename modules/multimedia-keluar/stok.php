...
if(isset($_POST['dataidbarang'])) {
	$kode_multimedia = $_POST['dataidbarang'];

  // fungsi query untuk menampilkan data dari tabel stok
  $query = mysqli_query($mysqli, "SELECT kode_multimedia,nama_multimedia,satuan,stok FROM sb_stok_multimedia WHERE kode_multimedia='$kode_multimedia'")
