...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO sb_network_keluar(id_keluar,tanggal_keluar,ref_ticket,kode_network,jumlah,penerima,created_user) 
                                            VALUES('$id_keluar','$tanggal_keluar','$ref_ticket','$kode_network','$jumlah','$penerima','$created_user')")
            ...
            if ($query) {
                ...
                if ($query1) {                       
                    ...
                    header("location: ../../main.php?module=network_keluar&alert=1");
                }
            }   
        }   
    }
