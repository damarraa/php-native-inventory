<script type="text/javascript">
  function tampil_barang(input){
    ...
    $.post("modules/network-keluar/stok.php", {
      dataidbarang: num,
    }, function(response) {      
      $('#stok').html(response)
  ...
  function cek_jumlah(input) {
    ...
    if (jumlah > stok_tersedia) {
      ...
      window.location.href='main.php?module=form_network_keluar&form=add';
    } else {
...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Input Barang Network Keluar
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=beranda"><i class="fa fa-home"></i> Beranda </a></li>
      <li><a href="?module=network_keluar"> Stok Keluar Network </a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/network-keluar/proses.php?act=insert" method="POST" name="formBarangKeluar">
            <div class="box-body">
              <?php  
              // fungsi untuk membuat kode transaksi
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(id_keluar,3) as kode FROM sb_network_keluar
              ...
              // buat id_network_keluar
              $tahun          = date("Y");
              $buat_id        = str_pad($kode, 3, "0", STR_PAD_LEFT);
              $id_keluar = "OUTNET-$tahun-$buat_id";
              ?>
            ...
            <div class="box-footer">
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a href="?module=network_keluar" class="btn btn-default btn-reset">Batal</a>
                </div>
              </div>
            </div><!-- /.box footer -->
          </form>
