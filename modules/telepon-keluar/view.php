...
<section class="content-header">
  <h1>
    <i class="fa fa-sign-out icon-title"></i> Data Stok Telepon Keluar

    <a class="btn btn-primary btn-social pull-right" href="?module=form_telepon_keluar&form=add" title="Tambah Data" data-toggle="tooltip" style="background-color: #0C2841;">
  ...
  <div class="row">
    ...
    elseif ($_GET['alert'] == 1) {
      echo "<div class='alert alert-success alert-dismissable'>
              ...
              Data stok telepon keluar berhasil disimpan.
            </div>";
    }
    ?>
        ...
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.id_keluar,a.tanggal_keluar,a.ref_ticket,a.kode_telepon,a.jumlah,a.penerima,b.kode_telepon,b.nama_telepon,b.satuan
                                            FROM sb_telepon_keluar as a INNER JOIN sb_stok_telepon as b ON a.kode_telepon=b.kode_telepon ORDER BY id_keluar DESC")
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td width='80' class='center'>$data[nama_telepon]</td>
