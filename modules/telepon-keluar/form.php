<script type="text/javascript">
  function tampil_barang(input){
    ...
    $.post("modules/telepon-keluar/stok.php", {
      dataidbarang: num,
    }, function(response) {      
      $('#stok').html(response)
  ...
  function cek_jumlah(input) {
    ...
    if (jumlah > stok_tersedia) {
      ...
      window.location.href='main.php?module=form_telepon_keluar&form=add';
    } else {
...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Input Barang Telepon Keluar
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=beranda"><i class="fa fa-home"></i> Beranda </a></li>
      <li><a href="?module=telepon_keluar"> Stok Keluar Telepon </a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/telepon-keluar/proses.php?act=insert" method="POST" name="formBarangKeluar">
            <div class="box-body">
              <?php  
              // fungsi untuk membuat kode transaksi
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(id_keluar,3) as kode FROM sb_telepon_keluar
              ...
              $id_keluar = "OUTTEL-$tahun-$buat_id";
              ?>
            ...
            <div class="box-footer">
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a href="?module=telepon_keluar" class="btn btn-default btn-reset">Batal</a>
                </div>
              </div>
            </div><!-- /.box footer -->
          </form>
