...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    <head>
        ...
        <title>LAPORAN DATA STOK NETWORK</title>
        <link rel="stylesheet" type="text/css" href="../../assets/css/laporan.css" />
    </head>
    <body>
        <div id="title">
            LAPORAN DATA STOK NETWORK 
        </div>
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td style='padding-left:5px;' width='180' height='13' valign='middle'>$data[tipe_network]</td>
                        <td style='padding-left:5px;' width='180' height='13' valign='middle'>$data[nama_network]</td>
...
<?php
$filename="Laporan Stok Network.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
