...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    <head>
        ...
        <title>LAPORAN DATA STOK MULTIMEDIA</title>
        <link rel="stylesheet" type="text/css" href="../../assets/css/laporan.css" />
    </head>
    <body>
        <div id="title">
            LAPORAN DATA STOK MULTIMEDIA 
        </div>
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td style='padding-left:5px;' width='180' height='13' valign='middle'>$data[tipe_multimedia]</td>
                        <td style='padding-left:5px;' width='180' height='13' valign='middle'>$data[nama_multimedia]</td>
...
<?php
$filename="Laporan Stok Multimedia.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
