...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO sb_telepon_masuk(id_masuk,tanggal_masuk,kode_telepon,jumlah,created_user) 
                                            VALUES('$id_masuk','$tanggal_masuk','$kode_telepon','$jumlah','$created_user')")
            ...
            if ($query) {
                ...
                if ($query1) {                       
                    ...
                    header("location: ../../main.php?module=telepon_masuk&alert=1");
                }
            }   
        }   
    }
