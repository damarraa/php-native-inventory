<script type="text/javascript">
  function tampil_barang(input){
    ...
    $.post("modules/telepon-masuk/stok.php", {
      dataidbarang: num,
    }, function(response) {      
      $('#stok').html(response)
...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Input Barang Telepon Masuk
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=beranda"><i class="fa fa-home"></i> Beranda </a></li>
      <li><a href="?module=telepon_masuk"> Stok Masuk Telepon </a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/telepon-masuk/proses.php?act=insert" method="POST" name="formBarangMasuk">
            <div class="box-body">
              <?php  
              // fungsi untuk membuat kode transaksi
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(id_masuk,3) as kode FROM sb_telepon_masuk
              ...
              // buat id_telepon_masuk
              $tahun          = date("Y");
              $buat_id        = str_pad($kode, 3, "0", STR_PAD_LEFT);
              $id_masuk = "TEL-$tahun-$buat_id";
              ?>

              <div class="form-group">
                <label class="col-sm-2 control-label">Kode Masuk Telepon</label>
                <div class="col-sm-5">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <select class="chosen-select" name="kode_telepon" data-placeholder="-- Pilih Barang --" onchange="tampil_barang(this)" autocomplete="off" required>
                    <option value=""></option>
                    <?php
                      $query_stok = mysqli_query($mysqli, "SELECT kode_telepon, nama_telepon FROM sb_stok_telepon ORDER BY nama_telepon ASC")
                                                            or die('Ada kesalahan pada query tampil stok: '.mysqli_error($mysqli));
                      while ($data_stok = mysqli_fetch_assoc($query_stok)) {
                        echo"<option value=\"$data_stok[kode_telepon]\"> $data_stok[kode_telepon] | $data_stok[nama_telepon] </option>";
                      }
                    ?>
                  </select>
                </div>
            ...
            <div class="box-footer">
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a href="?module=telepon_masuk" class="btn btn-default btn-reset">Batal</a>
                </div>
              </div>
            </div><!-- /.box footer -->
          </form>
