...
if ($_GET['form']=='add') { ?>
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Tambah Data Printer dan Toner
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/stokv2/proses.php?act=insert" method="POST">
            <div class="box-body">
              <?php  
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="tipe_printer" required>
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/stokv2/proses.php?act=update" method="POST">
            <div class="box-body">
            ...
            <div class="box-footer">
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <input type="submit" class="btn btn-primary btn-submit" name="simpan" value="Simpan">
                  <a href="?module=stokv2" class="btn btn-default btn-reset">Batal</a>
                </div>
              </div>
            </div><!-- /.box footer -->
          </form>
