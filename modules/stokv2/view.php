...
<section class="content-header">
  <h1>
    ...
    <a class="btn btn-primary btn-social pull-right" href="?module=form_stokv2&form=add" title="Tambah Data" data-toggle="tooltip" style="background-color: #0C2841;">
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td class='center' width='80'>
                        <div>
                          <a data-toggle='tooltip' data-placement='top' title='Ubah' style='margin-right:5px; background-color: #0C2841;' class='btn btn-primary btn-sm' href='?module=form_stokv2&form=edit&id=$data[kode_barang]'>
                              <i style='color:#fff' class='glyphicon glyphicon-edit'></i>
                          </a>";
            ?>
                          <a data-toggle="tooltip" data-placement="top" title="Hapus" style="background-color: #A32E37;" class="btn btn-danger btn-sm" href="modules/stokv2/proses.php?act=delete&id=<?php echo $data['kode_barang'];?>" onclick="return confirm('Anda yakin ingin menghapus stok <?php echo $data['nama_barang']; ?> ?');">
