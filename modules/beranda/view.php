...
?>
  ...
  <section class="content">
    ...
    <div class="row-visualize" style="display: flex; flex-direction: column;">
      <div class="top-column" style="width: 1500px; margin: 10px; display: flex; margin-left: -15px;">

        <div class="bar-horizontal">
          <div class="col-lg-4 col-xs-5">
            <div class="small-box" style="box-shadow: 0 0 24px 0 rgba(0, 0, 0, 0.12); background-color: #ffffff; border-radius: 5px; width: max-content;">
      ...
      <div class="bottom-column" style="width: 1500px; margin: 3px; display: flex;  margin-left: -15px;">
        ...
        <div class="bar-vertical">
          <div class="col-lg-2 col-xs-5">
            <div class="small-box" style="width: 713px; box-shadow: 0 0 24px 0 rgba(0, 0, 0, 0.12); background-color: #ffffff; border-radius: 5px;">
              <div class="inner">
