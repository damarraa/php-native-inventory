...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT a.id_masuk,a.tanggal_masuk,a.kode_multimedia,a.jumlah,b.kode_multimedia,b.nama_multimedia,b.satuan
                                    FROM sb_multimedia_masuk as a INNER JOIN sb_stok_multimedia as b ON a.kode_multimedia=b.kode_multimedia
...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    <head>
        ...
        <title>LAPORAN DATA STOK MASUK MULTIMEDIA</title>
        <link rel="stylesheet" type="text/css" href="../../assets/css/laporan.css" />
    </head>
    <body>
        <div id="title">
            LAPORAN DATA STOK MASUK MULTIMEDIA
        </div>
    <?php  
    ...
    // jika data tidak ada
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td width='120' height='13' align='center' valign='middle'>$data[kode_multimedia]</td>
                        <td width='80' height='13' align='center' valign='middle'>$tanggal_masuk</td>
                        <td width='80' height='13' align='center' valign='middle'>$data[kode_multimedia]</td>
                        <td style='padding-left:5px;' width='155' height='13' valign='middle'>$data[nama_multimedia]</td>
...
<?php
$filename="Laporan Data Stok Masuk Multimedia.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
