...
<section class="content-header">
  <h1>
    <i class="fa fa-sign-out icon-title"></i> Data Stok Toner Keluar

    <a class="btn btn-primary btn-social pull-right" href="?module=form_stok_keluar&form=add" title="Tambah Data" data-toggle="tooltip" style="background-color: #0C2841;">
        ...
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.id_keluar,a.tanggal_keluar,a.ref_ticket,a.kode_barang,a.jumlah,a.penerima,b.kode_barang,b.nama_barang,b.satuan
                                            FROM sb_barang_keluar as a INNER JOIN sb_stok_barang as b ON a.kode_barang=b.kode_barang ORDER BY id_keluar DESC")
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td width='80' class='center'>$data[nama_barang]</td>
