...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT a.id_keluar,a.tanggal_keluar,a.ref_ticket,a.kode_network,a.jumlah,a.penerima,b.kode_network,b.nama_network,b.satuan
                                    FROM sb_network_keluar as a INNER JOIN sb_stok_network as b ON a.kode_network=b.kode_network
...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    <head>
        ...
        <title>LAPORAN STOK KELUAR NETWORK</title>
        <link rel="stylesheet" type="text/css" href="../../assets/css/laporan.css" />
    </head>
    <body>
        <div id="title">
            LAPORAN STOK KELUAR NETWORK
        </div>
    <?php  
    ...
    // jika data tidak ada
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td width='100' height='13' align='center' valign='middle'>$data[kode_network]</td>
                        <td style='padding-left:5px;' width='120' height='13' valign='middle' align='center'>$data[nama_network]</td>
...
<?php
$filename="Laporan Data Stok Keluar Network.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
