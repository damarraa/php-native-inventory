...
$query = mysqli_query($mysqli, "SELECT id_user, nama_user, foto, hak_akses FROM sb_users WHERE id_user='$_SESSION[id_user]'")
...
<li class="dropdown user user-menu">
  ...
  <ul class="dropdown-menu">
    ...
    <li class="user-header">
      ...
      <?php  
      if ($data['foto']=="") { ?>
        <img src="images/user/user-default.png" class="img-square" alt="User Image"/>
      <?php
      }
      else { ?>
