...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Sistem Persediaan Barang Masuk dan Keluar | IT RU II</title>
    ...
    <!-- favicon -->
    <link rel="icon" href="assets/img/icon_pertamina.png" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <img style="margin-top:1px;margin-right:5px" src="assets/img/logo-pertamina-transparant.png" 
          alt="Logo" width="155px" height="45px"> 
        </a>
      ...
      <footer class="main-footer">
        <strong>PT KILANG PERTAMINA INTERNASIONAL | IT RU II SUNGAI PAKNING @2023</strong>
      </footer>
    </div><!-- ./wrapper -->
